...
sim <- "jsp"          # name your simulation
nsim <- 1             # number of replicates
time <- 100           # simulation time
k <- 200              # mainland carrying capacity
ipk <- 0.1            # proportion of the carrying capacity of the mainland that corresponds to the carrying capacity of the island
dopt <- 0             # difference between mainland ecological optimum (0) and island optimum (0+dopt) 
wopt <- 4             # width ecological niche (same for mainland and island optimum)
mr <- 0               # migration rate
